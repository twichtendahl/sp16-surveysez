 ...
 * @author Travis Wichtendahl <traviswichtendahl@gmail.com>
...
{#only load data if record found
	$config->titleTag = $Title . "Survey made with PHP & love!"; #overwrite PageTitle with Survey info!
}
/*
...
{#records exist - show survey!
    ...
    <p><b>Description:</b> ' . $mySurvey->Description . '</p>    
    ';
}else{//no such survey!
...
class Survey {
    ...
    function __construct($id) {
        ...
        //forcibly cast the data to an integer
        $id = (int)$id;
